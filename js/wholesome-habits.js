...
(function () {
  ...
  var require$$0 = (mdeLib && typeof mdeLib === 'object' && 'default' in mdeLib ? mdeLib['default'] : mdeLib);
  ...
  var require$$0$2 = (mdeIxEvents && typeof mdeIxEvents === 'object' && 'default' in mdeIxEvents ? mdeIxEvents['default'] : mdeIxEvents);

  var mdeDropdown = __commonjs(function (module) {
  /**
   * mde: Dropdown component
   */

  var mde = require$$0;
  var IXEvents = require$$0$2;

  mde.define('dropdown', module.exports = function($, _) {
    var api = {};
    var $doc = $(document);
    var $dropdowns;
    var designer;
    var inApp = mde.env();
    var touch = mde.env.touch;
  ...
  mde.define('scroll', module.exports = function($) {
    ...
    function findEl(hash, e) {
      ...
      var rootTag = mde.env('editor') ? '.w-editor-body' : 'body';
